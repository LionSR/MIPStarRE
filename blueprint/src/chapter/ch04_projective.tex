...
\begin{theorem}[Naimark dilation]\label{thm:naimark}
  \lean{MIPStarRE.LDT.Section5MakingMeasurementsProjective.naimark}
...
\begin{lemma}[Orthogonalization lemma for measurements]\label{lem:orthonormalization-main-lemma}
  \lean{MIPStarRE.LDT.Section5MakingMeasurementsProjective.orthonormalizationMainLemma}
...
\begin{theorem}[Orthogonalization lemma]\label{thm:orthonormalization}
  \lean{MIPStarRE.LDT.Section5MakingMeasurementsProjective.orthonormalization}
