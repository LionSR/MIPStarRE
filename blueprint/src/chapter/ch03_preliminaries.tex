...
\begin{definition}[Post-processing]\label{def:post-processing}
  % \lean tag removed: no matching declaration
...
\begin{definition}[Strong self-consistency]\label{def:strong-self-consistency}
  % \lean tag: BipartiteSSCRel used in Theorems, no standalone def
...
\begin{proof}
  ...
  \begin{equation}
    ...
    % Keep the paper's exact label, including the semicolon, for cross-reference fidelity.
