...
\begin{remark}[Internal-obligation form of the soundness theorem]\label{rem:main-formal-conditional}
	\lean{MIPStarRE.LDT.Test.mainFormal_ofInternalObligations}
	\uses{thm:main-formal, def:low-individual-degree-test, def:projective-strategy, def:polymeasurements, def:simeq}
	The internal-obligation theorem has the same public hypotheses and conclusion
	as Theorem~\ref{thm:main-formal}.  Its proof body isolates the remaining base
	and successor constructions as named internal obligations, rather than
