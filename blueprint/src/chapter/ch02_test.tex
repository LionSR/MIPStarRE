...
\begin{definition}[General projective strategy]\label{def:projective-strategy}
	...
	% `audits/2026-04-23_ch02-separate-local-spaces-scouting.md` proceeds in three stages:
	...
	% Stage 3 migrates theorem statements from the paper (`SymStrat`, `mainFormal`) to the
	% two-space API.
...
\begin{lemma}[Bipartite strategy block identities]\label{lem:bipartite-strategy-block-identities}
	\lean{MIPStarRE.LDT.BiProjStrat.localDirectSumBlock_nonneg, MIPStarRE.LDT.BiProjStrat.roleBlock_mul, MIPStarRE.LDT.BiProjStrat.roleBlock_nonneg}
