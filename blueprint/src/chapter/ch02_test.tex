...
\begin{remark}[Lean encoding of the conditional soundness theorem]\label{rem:main-formal-conditional}
	...
	The conditional theorem formalized at present assumes a repaired bridge from
	the role-register residual to the final projective-completion hypotheses.
	This is not a hypothesis of Theorem~\ref{thm:main-formal}; it is the
	remaining step needed to derive the paper theorem from the pass condition.
\end{remark}
