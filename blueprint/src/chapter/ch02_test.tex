...
\begin{remark}\label{fig:test}
  With probability $\tfrac13$ each, the verifier performs the axis-parallel lines test, the self-consistency test, or the diagonal lines test from Definition~\ref{def:low-individual-degree-test}. This is the textual form of the boxed figure in the source paper.
\end{remark}
