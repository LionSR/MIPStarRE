...
\begin{remark}[Conditional form of the soundness theorem]\label{rem:main-formal-conditional}
	...
	The conditional theorem currently assumes a repaired bridge from
