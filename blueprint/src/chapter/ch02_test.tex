...
\begin{remark}[Residual form of the final transport]\label{rem:main-formal-conditional}
	...
	The residual theorem is a Lean-only formally verified final-transport result: once the
	Section~6 role residual and the post-role projective-completion residual have
