...
\end{theorem}
\begin{remark}
	The current Lean declaration \lean{MIPStarRE.LDT.Test.classicalTestSoundness} keeps the quoted Polishchuk--Spielman implication explicit through the auxiliary hypothesis \lean{MIPStarRE.LDT.Test.TwoProverClassicalLIDBridgePackage}. This preserves the paper-faithful theorem statement above while making the deferred formalization gap visible in Lean. Accordingly, this result is not marked \leanok.
\end{remark}
\begin{proof}
