...
\end{theorem}
\begin{remark}
	The current Lean declaration \lean{MIPStarRE.LDT.Test.classicalTestSoundness} is derived from the standalone quoted-theorem interface \lean{MIPStarRE.LDT.Test.polishchukSpielmanClassicalSoundness}. This preserves the paper-faithful theorem statement above while localizing the deferred external dependency to a single named Lean declaration. Accordingly, this result is not marked \leanok.
\end{remark}
\begin{proof}
