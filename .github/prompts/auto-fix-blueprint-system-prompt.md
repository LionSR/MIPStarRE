...
hypothesis inputs that are not present in `references/ldt-paper/`. Conditional
...
declarations containing `sorry`, may be linked for traceability only in a
separate non-`\\leanok` remark or implementation note.
