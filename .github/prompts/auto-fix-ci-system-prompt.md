...
residual, repair, package, producer, or arbitrary hypothesis inputs. The only
acceptable extra hypotheses are boundary conditions genuinely needed to state
the same mathematics in Lean, such as positivity for a division, nonemptiness,
