...
the source-statement audit tracked in
\href{https://github.com/LionSR/MIPStarRE/issues/1458}{GitHub issue \#1458}.
A proof may be blocked at
an intermediate mathematical assertion.  If that assertion is added as a new
hypothesis to a theorem labelled as a paper theorem, the resulting Lean theorem
...
\paragraph{Paper-facing Lean declaration.}
...
\path{mainFormal_ofRepairedBridge}, \path{orthonormalization_ofInput}, or
\path{..._assuming...} are acceptable when the declaration is not presented as
the source theorem.  A conditional helper is useful because it preserves proof
content downstream of a gap, but it does not close the source theorem.
