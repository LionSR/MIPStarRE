...
%   - Be concise: answer what the source uses, what was checked, and the
%     verdict in the first page when possible. Avoid audit-log chronology.
...
\leanid{modelCorrected} in \doclink{MIPStarRE/Path/To/File.lean}.}
\[
  \mathcal H \land \mathcal K \Longrightarrow C.
\]
