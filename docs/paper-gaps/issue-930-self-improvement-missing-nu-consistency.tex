...
explicit \leanid{sorry} in the source-facing theorem, rather than by extra
hypotheses on a conditional substitute for the theorem.

The induction-step wrapper
...
The blueprint entry now points to the source-facing theorem
\leanid{selfImprovement}.  No top-level conditional obligation theorem is
advertised as the formalization of the paper theorem.  The proof-level gap is
...
to complete the proof of the source-facing theorem, not to reintroduce the
missing work as auxiliary hypotheses.
