...
In the current code, this is the route used by the repaired base-case Step-6
assembly theorem
\leanid{MIPStarRE.LDT.Test.mainFormal\_ofRoleResidualAndRepairedBridge}.  The
generic corrected route $\zeta_1 + \sqrt{\zeta_2}$ remains mathematically
available, but it is not the active route for the present formal theorem.
