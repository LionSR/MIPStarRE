...
These are not paper-gap notes.  They are action items.  When such an
improvement is identified, open a GitHub issue or pull request that describes
the proposed change and link to it from the note.  The note records the
mathematical justification; the issue drives the implementation.
