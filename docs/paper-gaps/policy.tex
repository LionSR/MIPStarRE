...
in one sitting.  The first page should answer three questions: what the source
uses, what the formalization or audit checked, and what the current verdict is.
Most notes should have four sections: the source assertion, the mathematical
mechanism being checked, the blueprint/formal comparison, and the conclusion.
Use more sections only when a counterexample or long derivation genuinely needs
room.
...
equations for the source assertion, the key calculation, and the corrected or
formal statement; avoid displays for traceability data, declaration names, or
long lists.  Paths, Lean declarations, issue numbers, and pull requests should
usually live in footnotes.  The body should read as mathematical prose, not as a
log of what commands were run.
