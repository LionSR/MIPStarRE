...
statement, including bridge, residual, repair, producer, or package data.  Such
a theorem is temporary proof debt, not a replacement for the source theorem.  The
note must say plainly that the Lean result is conditional, identify the
source-faithful theorem form that remains to be proved, and give the intended
producer theorem or removal plan.  The blueprint should not mark the
