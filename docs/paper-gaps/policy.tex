...
long lists.  The detailed form below fixes where such traceability data belongs;
the body should read as mathematical prose, not as a log of what commands were
run.
