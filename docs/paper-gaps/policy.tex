...
A note is required when the only Lean theorem available for a source-labelled
statement is conditional on an additional hypothesis not present in the cited
statement, including bridge, residual, repair, or obligation-structure data.
Such a theorem is temporary proof debt, not a replacement for the source
theorem.  The note must say plainly that the Lean result is conditional, identify the
source-faithful theorem form that remains to be proved, and give the intended
obligation discharger or removal plan.  The blueprint should not mark the
source-labelled statement with \verb|\leanok| by pointing to this conditional
helper.
