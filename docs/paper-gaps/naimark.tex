...
downstream LDT lemmas.  The full bipartite tensor-product assembly of the
paper's Naimark theorem is intentionally not formalized here; this note records
that deliberate gap at the same paper origin cited by the
\leanid{NaimarkStatement} declaration site.
