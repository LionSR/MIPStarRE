...
corresponding statement is now represented by the paper-facing theorem with a
tracked proof gap.%
...
This note is attached to \ghissue{1032}; the source-aligned theorem statement
keeps the remaining construction as a proof gap, while the weaker proved
