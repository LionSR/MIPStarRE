...
argument of \cite[Section~\emph{A semidefinite program}]{Ji2020LowIndividualDegree}.
...
\footnote{See \path{MatrixSdpOptimalWitness} in
\path{MIPStarRE/LDT/SelfImprovement/MatrixRealization.lean}, lines 42--96.}
