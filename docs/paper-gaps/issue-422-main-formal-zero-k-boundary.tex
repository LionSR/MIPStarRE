...
\begin{enumerate}
  ...
  the corrected two-space source theorem under \(k\ge 400md\) and \(0<k\).  The
  role-register construction and the subsequent scalar absorption are checked
  inside the theorem, not supplied as external hypotheses.
