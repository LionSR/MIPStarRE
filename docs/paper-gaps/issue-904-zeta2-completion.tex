...
calculation.\footnote{As of the 2026-05-22 audit, the corrected large-\(k\)
Section~6 small-error successor construction is proved.  The remaining direct
proof holes on the final-theorem route are the source-boundary obligations in
\path{MIPStarRE/LDT/MainInductionStep/Theorems/SourceTheorems.lean} and
\path{MIPStarRE/LDT/Test/MainTheorem/MainFormal.lean}.}  The calculation in
