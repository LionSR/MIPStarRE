...
\begin{enumerate}
  ...
  \leanid{projectiveNonMeasurement\_of\_sourceAlmostProjective\_two\_mul},
  \leanid{projectiveNonMeasurement\_of\_sourceAlmostProjective\_two\_mul\_full},
  ...
  \doclink{MIPStarRE/LDT/MakingMeasurementsProjective/SpectralTruncation/ProjectiveNonMeasurement.lean}.}
\end{enumerate}
...
constructive small-error branch with the paper's $2\zeta$ source-defect bound is
formalized by
\leanid{projectiveNonMeasurement\_of\_sourceAlmostProjective\_two\_mul} in
\doclink{MIPStarRE/LDT/MakingMeasurementsProjective/SpectralTruncation/ProjectiveNonMeasurement.lean}.
The unconditional spectral-truncation producers
\leanid{projectiveNonMeasurement\_of\_sourceAlmostProjective\_two\_mul\_full}
and
\leanid{projectiveNonMeasurement\_of\_sourceAlmostProjective\_full} combine that
branch with the exact $\zeta = 0$ endpoint and the trivial large-error case, and
