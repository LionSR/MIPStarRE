...
[`docs/project_conventions.md#linter-warnings`](project_conventions.md#linter-warnings). If a genuine false
...
When the staged files touch Lean, blueprint, paper-gap, proof-integrity,
review-policy, or agent-prompt surfaces under `.github/actions/`,
`.github/prompts/`, or `.github/workflows/`, it also runs the fast
statement-integrity audits:
