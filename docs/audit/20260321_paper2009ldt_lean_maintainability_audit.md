...
- The main structural problem is the internal import order.
  ...
  That is easy to build, but it is not the proof-dependency order described in `README.md`, `docs/20260320_ldt_source_map.md`, and `docs/20260320_ldt_blueprint_dependency_review.md`.
