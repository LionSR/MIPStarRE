...
| `scripts/check_blueprint_latex.py` | Blueprint LaTeX convention lint, currently forbidding active `cleveref` / `\Cref` uses. | `scripts/tests/test_check_blueprint_latex.py` | `.github/workflows/lint-blueprint.yml` |
