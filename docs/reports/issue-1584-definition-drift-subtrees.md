...
| Former `OrthonormalizationSpectralObligation` | retired from `MIPStarRE/LDT/SelfImprovement/Theorems/OrthonormalizationSpectral.lean` | The spectral truncation route is now represented directly by `spectralTruncationInput_of_sourceAlmostProjective`; no separate Section 9 obligation abbreviation remains. | `thm:self-improvement`, `thm:self-improvement-in-induction-section`, `thm:main-induction`, and `thm:main-formal`. | Retired under #1596; remaining repair and final-field work stays under #1515. |
