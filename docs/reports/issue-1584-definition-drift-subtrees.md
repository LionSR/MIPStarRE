...
| Section 6 self-improvement packages: `SelfImprovementData`, `AnswerSelfImprovementData`, and their `SliceStrategyTransport` records | `MIPStarRE/LDT/MainInductionStep/Statements.lean` and `MIPStarRE/LDT/MainInductionStep/Theorems/SelfImprovementAssembly/` | Internal packages for applying Section 9 to slices and transporting the resulting measurements back to the induction context. | `thm:self-improvement-in-induction-section`, `thm:main-induction`, and `thm:main-formal`. | #1503 and #1507. |
