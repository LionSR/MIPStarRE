...
still sees faithful boundary inputs: the Section 12 nontrivial regime now states
the boundedness witness positivity, averaged residual bound, and pointwise
domination hypotheses explicitly.
