...
directly by the carrier theorem.  The older degree-split declarations have been
removed, and the separate degree-zero family construction is no longer part of
the active route.
