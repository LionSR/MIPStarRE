...
| 19 | deleted | `MIPStarRE/LDT/Pasting/Bernoulli/FromHToG/PaperMoveChain/{Moves,Telescope}.lean` |
...
- Former `MoveChain.lean` lines 31--1105: now split across
  `MoveChain/{Base,Lifting,Chain}.lean`;
- Former `MoveChain.lean` lines 1185--2244: now split across
  `MoveChain/{BackChain,FlatChain,FlatChainStep}.lean`;
- Former `MoveChain.lean` line 2244 onward: now in `MoveChain/Core.lean`.
