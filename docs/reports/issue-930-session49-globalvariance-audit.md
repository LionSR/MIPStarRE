...
Issue #931 remains open and assigned to `jizhengfeng`; it owns the self-improvement
input producers for Section 6 and is outside this audit. Issue #834 remains open
for the `mainFormal` Step-6 witness residual. This audit therefore does not attempt
to construct any new proofs or modify any Lean sources.
