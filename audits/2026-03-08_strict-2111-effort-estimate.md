...
- `MIPStarRE/README.md`
- `MIPStarRE/audits/2026-03-08_strict-2111-roadmap.md`
- `MIPStarRE/audits/2026-03-07_mathlib-api-2111.md`
...
| `audits/2026-03-08_strict-2111-roadmap.md` | misaligned | Same issue: “Build a finite-dimensional measurement API” is the wrong top-level goal for the strict branch. |
| `audits/2026-03-07_mathlib-api-2111.md` | partially reusable | Useful for coding-theory, `hammingDist`, and weighted-kernel / expander ideas; misaligned for the operator-algebra core because it assumes finite matrices throughout. |
