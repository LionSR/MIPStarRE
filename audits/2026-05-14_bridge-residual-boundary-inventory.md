...
| `MainFormalRoleMeasurementWitness` | `MIPStarRE/LDT/Test/MainTheorem/RoleRegister/Core.lean` | Internal role-register measurement output from the Section 6 call, after scalar rewriting to the Section 3 cascade parameter. | Feeds `UnsymmetrizationBridgePackage` and the final projective-completion chain. |
