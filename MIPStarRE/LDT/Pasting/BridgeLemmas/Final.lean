import MIPStarRE.LDT.Pasting.BridgeLemmas.Commute.Theorem
import MIPStarRE.LDT.Pasting.BridgeLemmas.Consistency.IsSomeMass

/-!
# Section 12 pasting: bridge final statements

Final bridge lemmas deriving line consistency, point consistency, and the all-outcomes statement.
-/
...
lemma hAConsistency_submeas_core
    (params : Parameters)
    [FieldModel params.q]
    (strategy : SymStrat params.next ι)
    (family : IdxPolyFamily params ι)
