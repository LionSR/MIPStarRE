...
lemma orthonormalizationMainLemma {Outcome : Type*}
  ...
  intro _hCons
  -- TODO(#1032): formalize the heterogeneous spectral truncation and
  -- locality-preserving repair construction in the proof of
  -- `lem:orthonormalization-main-lemma`, rather than assuming these proof steps
