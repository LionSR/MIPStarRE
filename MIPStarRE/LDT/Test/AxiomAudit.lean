...
assert_no_sorry_axiom projectiveNonMeasurement_of_almostProjMeasStatement
assert_no_sorry_axiom projectiveNonMeasurement_of_almostProjMeasStatement_full
assert_no_sorry_axiom projectiveNonMeasurement_of_sourceAlmostProjective_full
assert_no_sorry_axiom spectralTruncationStatement_of_projectiveNonMeasurement
...
assert_no_sorry_axiom MatrixSdpOptimalWitnessWithDominance
assert_no_sorry_axiom MatrixSdpStatementWithSlacknessAndDominance
assert_no_sorry_axiom MatrixSdpCanonicalOptimalPairWithDominance
...
assert_no_sorry_axiom MatrixSdpCanonicalOptimalPair.withDominance
assert_no_sorry_axiom
  MatrixSdpCanonicalOptimalPairWithDominance.toMatrixSdpStatementWithSlacknessAndDominance
assert_no_sorry_axiom MatrixSdpCanonicalOptimalPairWithDominance.toCanonicalOptimalPair
assert_no_sorry_axiom
  MatrixSdpCanonicalOptimalPairWithDominance.toMatrixSdpStatementWithSlackness
assert_no_sorry_axiom matrixSdpComplementarySlacknessEquation
assert_no_sorry_axiom matrixSdpMeasurementWitness_of_canonicalFeasibleComplementarySlackness
assert_no_sorry_axiom sdpStatementWithSlackness_of_canonicalFeasibleComplementarySlackness
assert_no_sorry_axiom sdpStatementWithSlackness_of_canonicalOptimalPair
assert_no_sorry_axiom sdpStatementWithSlackness_of_exists_canonicalOptimalPair
assert_no_sorry_axiom sdpStatementWithSlackness_of_canonicalOptimalPairWithDominance
assert_no_sorry_axiom
  sdpStatementWithSlackness_of_canonicalOptimalPair_of_dualDominatesIdentity
assert_no_sorry_axiom sdpMeasurementWitness_of_canonicalOptimalPair
assert_no_sorry_axiom sdpMeasurementWitness_of_exists_canonicalOptimalPair
assert_no_sorry_axiom sdpMeasurementWitness_of_canonicalFeasibleComplementarySlackness
assert_no_sorry_axiom sdpMeasurementWitness_of_canonicalOptimalPairWithDominance
assert_no_sorry_axiom sdpMeasurementWitness_of_canonicalOptimalPair_of_dualDominatesIdentity
...
assert_no_sorry_axiom
  matrixSdpPrimalTotalEqOne_extracted_of_canonicalComplementarySlackness_of_one_le
assert_no_sorry_axiom
  matrixSdpStatementWithSlacknessAndDominance_of_canonicalComplementarySlackness
assert_no_sorry_axiom
  matrixSdpStatementWithSlacknessAndDominance_of_canonicalFeasibleComplementarySlackness
assert_no_sorry_axiom MatrixSdpStatementWithSlacknessAndDominance.exists_measurement_witness
...
assert_no_sorry_axiom matrixSdpOptimalWitnessWithDominance_of_canonicalComplementarySlackness
assert_no_sorry_axiom
