...
Compatibility module for the role-register residuals used by the `mainFormal`
assembly.

Earlier versions of this module exported branch residual records for ordinary
