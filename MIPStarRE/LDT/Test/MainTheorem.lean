...
theorem mainFormal
  ...
  -- data plus the large-`k` or small-`k` split), projectivization/completion
  -- closeness and polynomial `ζ₁` transport links (#426), the full-slice
  -- transport chain (#601), the
  ...
  · have hepsNN : 0 ≤ eps := ProjStrat.eps_nonneg_of_passes hpass
    ...
    have rolePackageResidualCompletionLine169Residual :
      ...
      -- TODO(#427): construct the concrete Section 6 role residual, completion
      -- witnesses, and exact polynomial line-169 transport links.
      sorry
