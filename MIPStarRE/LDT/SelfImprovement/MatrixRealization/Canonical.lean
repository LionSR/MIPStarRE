...
This module contains the canonical objective and dual operators, the conversion
from canonical complementary slackness to the paper-form SDP witness, and the
measurement witness extracted from a canonical feasible complementary pair.
