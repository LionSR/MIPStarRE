...
This compatibility module imports the small, explicitly-invoked LDT proof helpers:
...
The compatibility module is intended for scratch files and small proof modules that genuinely
